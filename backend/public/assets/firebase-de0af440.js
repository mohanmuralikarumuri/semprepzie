 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yo="FirebaseError";class _e extends Error{constructor(e,n,r){super(n),this.code=e,this.customData=r,this.name=Yo,Object.setPrototypeOf(this,_e.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,bt.prototype.create)}}class bt{constructor(e,n,r){this.service=e,this.serviceName=n,this.errors=r}create(e,...n){const r=n[0]||{},o=`${this.service}/${e}`,c=this.errors[e],l=c?Qo(c,r):"Error",p=`${this.serviceName}: ${l} (${o}).`;return new _e(o,p,r)}}function Qo(i,e){return i.replace(Zo,(n,r)=>{const o=e[r];return o!=null?String(o):`<${r}?>`})}const Zo=/\{\$([^}]+)}/g;function ea(i){for(const e in i)if(Object.prototype.hasOwnProperty.call(i,e))return!1;return!0}function tn(i,e){if(i===e)return!0;const n=Object.keys(i),r=Object.keys(e);for(const o of n){if(!r.includes(o))return!1;const c=i[o],l=e[o];if(_r(c)&&_r(l)){if(!tn(c,l))return!1}else if(c!==l)return!1}for(const o of r)if(!n.includes(o))return!1;return!0}function _r(i){return i!==null&&typeof i=="object"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ze=Ya;function nc(i,e={}){let n=i;typeof e!="object"&&(e={name:e});const r=Object.assign({name:Qn,automaticDataCollectionEnabled:!1},e),o=r.name;if(typeof o!="string"||!o)throw Ce.create("bad-app-name",{appName:String(o)});if(n||(n=rs()),!n)throw Ce.create("no-options");const c=nn.get(o);if(c){if(tn(n,c.options)&&tn(r,c.config))return c;throw Ce.create("duplicate-app",{appName:o})}const l=new aa(o);for(const y of Zn.values())l.addComponent(y);const p=new tc(n,r,l);return nn.set(o,p),p}function cs(i=Qn){const e=nn.get(i);if(!e&&i===Qn&&rs())return nc();if(!e)throw Ce.create("no-app",{appName:i});return e}function Oe(i,e,n){var r;let o=(r=Qa[i])!==null&&r!==void 0?r:i;n&&(o+=`-${n}`);const c=o.match(/\s|\//),l=e.match(/\s|\//);if(c||l){const p=[`Unable to register library "${o}" with version "${e}":`];c&&p.push(`library name "${o}" contains illegal characters (whitespace or "/")`),c&&l&&p.push("and"),l&&p.push(`version name "${e}" contains illegal characters (whitespace or "/")`),me.warn(p.join(" "));return}Xe(new Fe(`${o}-version`,()=>({library:o,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ic="firebase-heartbeat-database",rc=1,At="firebase-heartbeat-store";let zn=null;function hs(){return zn||(zn=Ia(ic,rc,{upgrade:(i,e)=>{switch(e){case 0:try{i.createObjectStore(At)}catch(n){console.warn(n)}}}}).catch(i=>{throw Ce.create("idb-open",{originalErrorMessage:i.message})})),zn}async function sc(i){try{const n=(await hs()).transaction(At),r=await n.objectStore(At).get(ls(i));return await n.done,r}catch(e){if(e instanceof _e)me.warn(e.message);else{const n=Ce.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});me.warn(n.message)}}}async function Ar(i,e){try{const r=(await hs()).transaction(At,"readwrite");await r.objectStore(At).put(e,ls(i)),await r.done}catch(n){if(n instanceof _e)me.warn(n.message);else{const r=Ce.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});me.warn(r.message)}}}function ls(i){return`${i.name}!${i.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rn=new ri("@firebase/auth");function fc(i,...e){rn.logLevel<=O.WARN&&rn.warn(`Auth (${Ze}): ${i}`,...e)}function Xt(i,...e){rn.logLevel<=O.ERROR&&rn.error(`Auth (${Ze}): ${i}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Pt{constructor(e,n){this.shortDelay=e,this.longDelay=n,ve(n>e,"Short delay should be less than long delay!"),this.isMobile=Wo()||Ko()}get(){return gc()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _c=new Pt(3e4,6e4);function ye(i,e){return i.tenantId&&!e.tenantId?Object.assign(Object.assign({},e),{tenantId:i.tenantId}):e}async function ae(i,e,n,r,o={}){return gs(i,o,async()=>{let c={},l={};r&&(e==="GET"?l=r:c={body:JSON.stringify(r)});const p=Rt(Object.assign({key:i.config.apiKey},l)).slice(1),y=await i._getAdditionalHeaders();y["Content-Type"]="application/json",i.languageCode&&(y["X-Firebase-Locale"]=i.languageCode);const w=Object.assign({method:e,headers:y},c);return zo()||(w.referrerPolicy="no-referrer"),ps.fetch()(ms(i,i.config.apiHost,n,p),w)})}async function gs(i,e,n){i._canInitEmulator=!1;const r=Object.assign(Object.assign({},vc),e);try{const o=new Ic(i),c=await Promise.race([n(),o.promise]);o.clearNetworkTimeout();const l=await c.json();if("needConfirmation"in l)throw qt(i,"account-exists-with-different-credential",l);if(c.ok&&!("errorMessage"in l))return l;{const p=c.ok?l.errorMessage:l.error.message,[y,w]=p.split(" : ");if(y==="FEDERATED_USER_ID_ALREADY_LINKED")throw qt(i,"credential-already-in-use",l);if(y==="EMAIL_EXISTS")throw qt(i,"email-already-in-use",l);if(y==="USER_DISABLED")throw qt(i,"user-disabled",l);const S=r[y]||y.toLowerCase().replace(/[_\s]+/g,"-");if(w)throw fs(i,S,w);ne(i,S)}}catch(o){if(o instanceof _e)throw o;ne(i,"network-request-failed",{message:String(o)})}}async function kt(i,e,n,r,o={}){const c=await ae(i,e,n,r,o);return"mfaPendingCredential"in c&&ne(i,"multi-factor-auth-required",{_serverResponse:c}),c}function ms(i,e,n,r){const o=`${e}${n}?${r}`;return i.config.emulator?hi(i.config,o):`${i.config.apiScheme}://${o}`}function yc(i){switch(i){case"ENFORCE":return"ENFORCE";case"AUDIT":return"AUDIT";case"OFF":return"OFF";default:return"ENFORCEMENT_STATE_UNSPECIFIED"}}class Ic{constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((n,r)=>{this.timer=setTimeout(()=>r(se(this.auth,"network-request-failed")),_c.get())})}clearNetworkTimeout(){clearTimeout(this.timer)}}function qt(i,e,n){const r={appName:i.name};n.email&&(r.email=n.email),n.phoneNumber&&(r.phoneNumber=n.phoneNumber);const o=se(i,e,r);return o.customData._tokenResponse=n,o}function Pr(i){return i!==void 0&&i.enterprise!==void 0}class Ec{constructor(e){if(this.siteKey="",this.recaptchaEnforcementState=[],e.recaptchaKey===void 0)throw new Error("recaptchaKey undefined");this.siteKey=e.recaptchaKey.split("/")[3],this.recaptchaEnforcementState=e.recaptchaEnforcementState}getProviderEnforcementState(e){if(!this.recaptchaEnforcementState||this.recaptchaEnforcementState.length===0)return null;for(const n of this.recaptchaEnforcementState)if(n.provider&&n.provider===e)return yc(n.enforcementState);return null}isProviderEnabled(e){return this.getProviderEnforcementState(e)==="ENFORCE"||this.getProviderEnforcementState(e)==="AUDIT"}}async function wc(i,e){return ae(i,"GET","/v2/recaptchaConfig",ye(i,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Yc(i,e){return kt(i,"POST","/v1/accounts:signInWithPassword",ye(i,e))}async function Os(i,e){return ae(i,"POST","/v1/accounts:sendOobCode",ye(i,e))}async function Qc(i,e){return Os(i,e)}async function Zc(i,e){return Os(i,e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function eh(i,e){return kt(i,"POST","/v1/accounts:signInWithEmailLink",ye(i,e))}async function th(i,e){return kt(i,"POST","/v1/accounts:signInWithEmailLink",ye(i,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Je(i,e){return kt(i,"POST","/v1/accounts:signInWithIdp",ye(i,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ct extends Ds{constructor(){super(...arguments),this.scopes=[]}addScope(e){return this.scopes.includes(e)||this.scopes.push(e),this}getScopes(){return[...this.scopes]}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function sh(i,e){return kt(i,"POST","/v1/accounts:signUp",ye(i,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Us(i){const e=De(i);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function Vl(i,e,n){const r=De(i),o={requestType:"PASSWORD_RESET",email:e,clientType:"CLIENT_TYPE_WEB"};n&&Ms(r,o,n),await on(r,o,"getOobCode",Zc)}async function Hl(i,e,n){if(re(i.app))return Promise.reject(ge(i));const r=De(i),l=await on(r,{returnSecureToken:!0,email:e,password:n,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",sh).catch(y=>{throw y.code==="auth/password-does-not-meet-requirements"&&Us(i),y}),p=await Be._fromIdTokenResponse(r,"signIn",l);return await r._updateCurrentUser(p.user),p}function $l(i,e,n){return re(i.app)?Promise.reject(ge(i)):ch(ie(i),et.credential(e,n)).catch(async r=>{throw r.code==="auth/password-does-not-meet-requirements"&&Us(i),r})}async function Wl(i,e){const n=ie(i),o={requestType:"VERIFY_EMAIL",idToken:await i.getIdToken()};e&&Ms(n.auth,o,e);const{email:c}=await Qc(n.auth,o);c!==i.email&&await i.reload()}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function zl(i,{displayName:e,photoURL:n}){if(e===void 0&&n===void 0)return;const r=ie(i),c={idToken:await r.getIdToken(),displayName:e,photoUrl:n,returnSecureToken:!0},l=await Ye(r,hh(r.auth,c));r.displayName=l.displayName||null,r.photoURL=l.photoUrl||null;const p=r.providerData.find(({providerId:y})=>y==="password");p&&(p.displayName=r.displayName,p.photoURL=r.photoURL),await r._updateTokensIfNecessary(l)}function lh(i,e,n,r){return ie(i).onIdTokenChanged(e,n,r)}function uh(i,e,n){return ie(i).beforeAuthStateChanged(e,n)}function Gl(i,e,n,r){return ie(i).onAuthStateChanged(e,n,r)}function Kl(i){return ie(i).signOut()}const cn="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Dh="pendingRedirect",Qt=new Map;class Nh extends zs{constructor(e,n,r=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],n,void 0,r),this.eventId=null}async execute(){let e=Qt.get(this.auth._key());if(!e){try{const r=await Lh(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(r)}catch(n){e=()=>Promise.reject(n)}Qt.set(this.auth._key(),e)}return this.bypassAuthState||Qt.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const n=await this.auth._redirectUserForId(e.eventId);if(n)return this.user=n,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function Lh(i,e){const n=xh(e),r=Uh(i);if(!await r._isAvailable())return!1;const o=await r._get(n)==="true";return await r._remove(n),o}function Mh(i,e){Qt.set(i._key(),e)}function Uh(i){return pe(i._redirectPersistence)}function xh(i){return Yt(Dh,i.config.apiKey,i.name)}async function Fh(i,e,n=!1){if(re(i.app))return Promise.reject(ge(i));const r=De(i),o=Rh(r,e),l=await new Nh(r,o,n).execute();return l&&!n&&(delete l.user._redirectEventId,await r._persistUserIfCurrent(l.user),await r._setRedirectUser(null,e)),l}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qe=new ri("@firebase/firestore");function te(i,...e){if(Qe.logLevel<=O.DEBUG){const n=e.map(mi);Qe.debug(`Firestore (${Dt}): ${i}`,...n)}}function qs(i,...e){if(Qe.logLevel<=O.ERROR){const n=e.map(mi);Qe.error(`Firestore (${Dt}): ${i}`,...n)}}function Sl(i,...e){if(Qe.logLevel<=O.WARN){const n=e.map(mi);Qe.warn(`Firestore (${Dt}): ${i}`,...n)}}function mi(i){if(typeof i=="string")return i;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vi(i="Unexpected state"){const e=`FIRESTORE (${Dt}) INTERNAL ASSERTION FAILED: `+i;throw qs(e),new Error(e)}function wt(i,e){i||vi()}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
